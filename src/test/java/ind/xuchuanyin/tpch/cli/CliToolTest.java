package ind.xuchuanyin.tpch.cli;
...
import ind.xuchuanyin.tpch.e2e.TpchModel;
...
public class CliToolTest {
  private static final File TEST_DATA_GEN_OUT = FileUtils.getFile("test_gen_out");
  private static final File TEST_QUERY_REPORT_OUT = FileUtils.getFile("test_report_out");
  private static final File TEST_TPCH_META = FileUtils.getFile("test_tpch_meta.json");
  private static final File TEST_MERGE_REPORT_OUT = FileUtils.getFile("test_merge_report_out");
